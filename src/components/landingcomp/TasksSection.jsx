      ...
      <div style={{ maxWidth:1200, margin:'0 auto' }}>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'center', marginBottom:80 }}>
          <div className="reveal">
            ...
            <a href="#rewards-section" className="btn-primary" style={{ fontSize:'0.95rem', padding:'14px 32px' }}>Browse All Tasks →</a>
          </div>

          <div className="reveal" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
            {tasks.map((t, i) => (
              <div key={i} style={{ background:'#FAFAFA', borderRadius:18, padding:'20px',
