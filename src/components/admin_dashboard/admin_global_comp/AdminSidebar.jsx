...
const NavItem = memo(({ item, active, onMouseEnter, onMouseLeave, onClick }) => (
  <NavLink
    to={item.path}
...
const AdminSidebar = ({ isOpen, closeSidebar, isCollapsed, toggleCollapse }) => {
  ...
  const scrollbarStyles = `
    ...
    .custom-scrollbar { scrollbar-width: thin; scrollbar-color: rgba(255, 107, 0, 0.2) transparent; overflow-y: auto; overflow-x: hidden; }
  `;
  ...
  return (
    <>
      ...
      {/* DESKTOP SIDEBAR */}
      <aside
        className="hidden lg:flex flex-col sticky self-start w-64 shrink-0 custom-scrollbar"
        style={{
          ...sidebarBase,
          top: "65px",
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed top-0 left-0 h-full z-[70] custom-scrollbar w-[280px] max-w-[85vw] flex flex-col shadow-2xl"
              style={sidebarBase}
            >
              <div className="flex items-center justify-between p-4 border-b border-white/5">
                <span className="text-sm font-bold tracking-widest text-[#FF6B00]">MENU</span>
                <button 
                  onClick={closeSidebar}
